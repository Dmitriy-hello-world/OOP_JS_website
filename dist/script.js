...
window.addEventListener('DOMContentLoaded', function () {
  ...
  feedSlider.render();
  new _modules_videoPlayer__WEBPACK_IMPORTED_MODULE_2__["default"]('.page .play', '.overlay').render();
  ...
  new _modules_form__WEBPACK_IMPORTED_MODULE_4__["default"]('form').render();
  new _modules_showInfo__WEBPACK_IMPORTED_MODULE_5__["default"]('.plus__content').render();
  new _modules_download__WEBPACK_IMPORTED_MODULE_6__["default"]('.download').render();
});
...
function () {
  ...
  _createClass(Form, [{
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              _context.next = 5;
              return regeneratorRuntime.awrap(this.result.text());
    ...
    key: "textChecked",
    value: function textChecked() {
      this.mailInputs.forEach(function (item) {
    ...
    value: function mask() {
      ...
      this.phoneInputs.forEach(function (item) {
    ...
    value: function bindForms() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          ...
          statusBlock.textContent = _this.message.loading;

          _this.postData(_this.formData, _this.url).then(function (res) {
            console.log(res);
          }).catch(function () {
            statusBlock.textContent = _this.message.fail;
          }).finally(function () {
            statusBlock.textContent = _this.message.succes;
    ...
    value: function render() {
      this.triggers.forEach(function (btn) {
        btn.addEventListener('click', function () {
          var infoBlock = btn.closest('.module__info-show').nextElementSibling;
...
function (_Slider) {
  ...
  _createClass(MainSLider, [{
    key: "plusSlideIndex",
    value: function plusSlideIndex(n) {
      this.slideIndex += n;
...
function (_Slider) {
  ...
  function MiniSlider(page, next, prev, autoplay, animate, active) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, page, next, prev, autoplay, animate, active));
  }
  ...
  _createClass(MiniSlider, [{
    ...
    value: function setActive() {
      ...
      this.slides.forEach(function (slide) {
        slide.classList.remove(_this.active);
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$teacher = _ref.teacher,
      teacher = _ref$teacher === void 0 ? null : _ref$teacher,
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function onPlayerStateChange(e) {
      try {
        ...
        if (e.data === 0) {
          if (blockedBlock.querySelector('.play__circle').classList.contains('closed') && blockedBlock.querySelector('.play__text').classList.contains('attention')) {
